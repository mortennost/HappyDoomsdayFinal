...
public class BuildTrapInputLayer : InputLayer {
	
	//InputHandler inputHandler;
	
	public Vector3 swipeBeganPosition;
	public Vector3 snapperSwipeBeganPosition;
	...
	{		
		...
		place = GameObject.Find("GUI").GetComponent<iGUICode_GUI_mockup2>()._btnPlaceTrap.rect;
		cancel = GameObject.Find("GUI").GetComponent<iGUICode_GUI_mockup2>()._btnCancelTrap.rect;
